...
<head>
    ...
    <title>CT Phiếu Xuất | Quản Lý Siêu Thị</title>
...
<body class="bg-light">
        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-sm-start text-center" aria-current="page" href="/ct-phieu-xuat">CT Phiếu Xuất</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        ...
        <div class="card mb-5">
            ...
            <!-- CT Phiếu Xuất data -->
            <div class="card-body">
                <h3 class="card-title">CT Phiếu Xuất</h3>
                ...
                <?php
                $px = mysqli_query($db, "SELECT * FROM `PHIEUXUAT`");
                ...
                <form class="row g-3" action="create.php" method="POST">
                    <div class="col-md-6">
                        <label for="MaPX" class="form-label">Phiếu Xuất</label>
                        <select class="form-select" name="MaPX" aria-label="Default select example">
                            <?php
                            while ($item = mysqli_fetch_array($px)) {
                                echo $item;
                                echo "<option value='" . $item['MaPX'] . "'>" . $item['MaPX'] . "</option>";
                            }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6">
                        <label for="SLuongBan" class="form-label">Số Lượng Bán</label>
                        <input type="number" step=0.01 name="SLuongBan" class="form-control" placeholder="10" required>
                    </div>
        ...
        <div class="table-responsive mb-5 card">
            ...
            echo "<th scope='col'>Số Lượng Bán</th>";
            ...
            $data = mysqli_query($db, "SELECT * FROM CTPHIEUXUAT");
            $amount_data = mysqli_num_rows($data);
            $total_pages = ceil($amount_data / $per_page);

            $data_mhs = mysqli_query($db, "SELECT * FROM CTPHIEUXUAT LIMIT $page, $per_page");
            $no = $page + 1;
                    ...
                    <form action='edit.php' method='POST'>
                        <div class='modal-body text-start'>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" name="edit_MaPX" id="edit_MaPX" class="form-control" placeholder="MPN01" readonly>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                <label for="edit_SLuongBan" class="form-label">Số Lượng Bán</label>
                                <input type="number" step=0.01 name="edit_SLuongBan" id="edit_SLuongBan" class="form-control" placeholder="10" required>
                            </div>
            ...
            <div class='modal-dialog'>
                <div class='modal-content'>
                    ...
                    <form action='delete.php' method='POST'>
                        ...
                        <div class='modal-body text-start'>
                            <input type='hidden' name='delete_MaPX' id='delete_MaPX'>
